...
keywords: property search, web application, New Zealand, real estate, PHP, web development
...
<img loading="lazy" style="margin-left: 60px; float: left; height: 465px" src="/media/projects/houser/flyer.svg" alt="Flyer">
<p style="text-align: center;">
  <img loading="lazy" style="margin-bottom: 10px" src="/media/projects/houser/Houser-FootpathSign-2012-10-17 06.58.09.webp" alt="Houser FootpathSign" width="310" height="232">
  <img loading="lazy" src="/media/projects/houser/flyers.webp" alt="Flyers" width="309" height="232">
</p>

## Screenshots

<p style="text-align: center;">
  <a href="/media/projects/houser/Houser-Screenshot-Homepage.webp">
    <img loading="lazy" style="text-align: center;" src="/media/projects/houser/Houser-Screenshot-Homepage.webp" alt="Houser Screenshot Homepage">
  </a>
</p>
<p style="text-align: center;">
  <a href="/media/projects/houser/Houser-Screenshot-Listing.webp">
    <img loading="lazy" style="text-align: center;" src="/media/projects/houser/Houser-Screenshot-Listing.webp" alt="Houser Screenshot Listing">
  </a>
</p>
<p style="text-align: center;">
  <a href="/media/projects/houser/Houser-Screenshot-Search.webp">
    <img loading="lazy" style="text-align: center;" src="/media/projects/houser/Houser-Screenshot-Search.webp" alt="Houser Screenshot Search">
  </a>
</p>
<p style="text-align: center;">
  <a href="/media/projects/houser/Houser-Screenshot-Transaction.webp">
    <img loading="lazy" style="text-align: center;" src="/media/projects/houser/Houser-Screenshot-Transaction.webp" alt="Houser Screenshot Transaction">
  </a>
</p>
